...
driver.find_element(By.XPATH, '//*[@id="form"]/div[2]/input').send_keys(user_pw) # 비번 특문제거 
...
# alert 창이 뜨는 경우, 확인을 눌러서 끔. 없으면 pass
try :
...
driver.find_element(By.XPATH, '//*[@id="login_id"]').send_keys(user_id)
